package com.alok.cloud.service.broker.mail;

import com.alok.cloud.service.broker.mail.model.MailServiceBinding;
import com.alok.cloud.service.broker.mail.model.MailServiceInstance;
...
// Alok - this service is responsible for creating service instance and service binding
    //  creating service instance -  PUT http://localhost:8080/broker/v2/service_instances/alok.ku.singh@gmail.com
        // this will create service instance and will return Dashboard URL
    // binding service - PUT http://localhost:8080/broker/v2/service_instances/alok.ku.singh@gmail.com/service_bindings/admin
        // this will setup login credentials and will return the credentials
@Service
